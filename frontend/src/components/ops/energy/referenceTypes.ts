import { ConsumptionScope, WingCode } from "./types";
...
export type EnergyReferenceData = ConsumptionScope & { wings: Record<WingCode, WingReference>; society_historical_daily_kwh: number | null; society_reference_daily_kwh: number | null; society_reference_source: string; grid: GridReference; allocation: AllocationReference };
